> NOTE: Adapted from [*Think Python*, 3rd edition](https://allendowney.github.io/ThinkPython/) by Allen B. Downey, [Chapter 11: Tuples](https://github.com/AllenDowney/ThinkPython/blob/v3/chapters/chap11.ipynb). Provided here for convenience.
...
print(most_frequent_letters(string))
```
...
def run_doctests(func):
    run_docstring_examples(func, globals(), name=func.__name__)
print(run_doctests(word_distance))
```
