> NOTE: Adapted from [*Think Python*, 3rd edition](https://allendowney.github.io/ThinkPython/) by Allen B. Downey, [Chapter 2: Variables and Statements](https://github.com/AllenDowney/ThinkPython/blob/v3/chapters/chap02.ipynb). Provided here for convenience.
