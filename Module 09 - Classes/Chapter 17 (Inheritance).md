> NOTE: Adapted from [*Think Python*, 3rd edition](https://allendowney.github.io/ThinkPython/) by Allen B. Downey, [Chapter 17: Inheritance](https://github.com/AllenDowney/ThinkPython/blob/v3/chapters/chap17.ipynb). Provided here for convenience.
...
for rank in range(10, 15):
    ...
    good_hand.put_card(card)
print(good_hand)
print(good_hand.get_suit_counts())
```
...
class PokerHand(Hand):
    ...
    def get_rank_counts(self):
        ...
        for card in self.cards:
            ...
            counter[key] = counter.get(key, 0) + 1
        return counter
cards = [Card(0, 2), Card(0, 3), Card(2, 4), Card(3, 5), Card(0, 7)]
bad_hand = PokerHand('bad hand')
for card in cards:
    bad_hand.put_card(card)
print(bad_hand)
print(bad_hand.has_flush())
```
...
for rank in range(10, 15):
    ...
    good_hand.put_card(card)
print(good_hand)
print(good_hand.get_rank_counts())
```
...
for rank in range(10, 15):
    ...
    good_hand.put_card(card)
print(good_hand)
print(good_hand.has_straightflush())
```
...
for card in cards:
    bad_hand.put_card(card)
print(bad_hand)
print(bad_hand.has_straightflush())
```
...
print(straight_and_flush.put_card(Card(0, 6)))
print(straight_and_flush.put_card(Card(0, 9)))
...
print(straight_and_flush.put_card(Card(0, 9)))
print(straight_and_flush)
print((straight_and_flush.has_straight(), straight_and_flush.has_flush()))
```
...
print(straight_and_flush.put_card(Card(0, 9)))
print(straight_and_flush)
print(straight_and_flush.has_straightflush())
```
...
print(pair)
boat = deepcopy(pair)
print(boat.put_card(Card(2, 2)))
print(boat.put_card(Card(2, 3)))
print(boat)
```
...
for rank in range(10, 15):
    ...
    good_hand.put_card(card)
print(good_hand)
print(good_hand.has_full_house())
```
...
kanga = Kangaroo('Kanga')
roo = Kangaroo('Roo')
print(kanga.put_in_pouch('wallet'))
print(kanga.put_in_pouch('car keys'))
