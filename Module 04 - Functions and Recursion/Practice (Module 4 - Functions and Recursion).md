...
This assignment provides an opportunity to apply the concepts covered in this module by writing Python programs using default arguments, functions that call other functions, and recursion.

You will complete:

- One problem from Section 1 – Default Arguments
- One problem from Section 2 – Functions Calling Functions
- One problem from Section 3 – Recursion
...
| Problem | File Name |
|---------|-----------|
| Calculator with Default Arguments | `program1a.py` |
| Rectangle/Square Area Calculator | `program1b.py` |
| Password Strength Checker | `program2a.py` |
| Circle Calculator | `program2b.py` |
| Fibonacci Calculator | `program3a.py` |
| Power Calculator | `program3b.py` |
...
### Section 1 - Default Arguments (Choose One)
...
- Create a function `add_numbers(a, b, c=0)` with a default argument for the third number
- Create a function `multiply_numbers(a, b, c=1)` with a default argument for the third number
...
- If they choose yes: ask for the third number and use it in calculations
...
- Create a function `rectangle_area(length, width=None)` with a default argument for width
...
### Section 2 - Functions Calling Functions (Choose One)
...
Create a program with functions where one function calls others to calculate circle properties.
...
### Section 3 - Recursion (Choose One)
...
- Include a proper base case (`power(base, 0) = 1`)
...
- ☐ Completed one Default Arguments problem
- ☐ Completed one Functions Calling Functions problem
- ☐ Completed one Recursion problem
- ☐ Correct file names
